      ...
      <div className="container mx-auto px-4 md:px-8 max-w-5xl relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-gray-900 mb-4">
            Experience Hunar Bazaar
          </h2>
          <p className="text-lg text-gray-600 font-light">
            Watch how Hunar Bazaar transforms ideas into reality
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="aspect-video bg-gradient-to-br from-gray-900 via-primary/40 to-secondary/40 flex items-center justify-center relative">
              {/* Official event image as background */}
              <img
                src={bannerImage}
                alt="Hunar Bazaar 2026 — Event Teaser"
          ...
          <div className="hidden">
            <iframe
              ...
              title="Hunar Bazaar Promotional Video"
              frameBorder="0"
        ...
        >
          <p className="text-gray-600 font-light max-w-2xl mx-auto">
            Discover the magic of Hunar Bazaar 2026 and get inspired to showcase your creativity and entrepreneurial spirit.
          </p>
        </motion.div>
      </div>
    </section>
