...
<p className="text-gray-400 font-medium leading-relaxed">Transfer the initialization fee of ₹200 to the central vault.</p>
                </li>
                <li className="flex gap-4 group">
          ...
          >
            <div className="glass-card p-4 md:p-8 shadow-[0_0_40px_rgba(16,185,129,0.1)] border border-[#10B981]/20 bg-[#1A233A]/60 h-full min-h-[800px] flex flex-col relative">
              <div className="flex justify-between items-center mb-6 px-4 relative z-10">
                ...
                <a href={googleFormUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackExternalLink('google_form')} className="text-sm font-bold text-[#10B981] hover:text-white transition-colors flex items-center gap-2 group uppercase tracking-widest">
