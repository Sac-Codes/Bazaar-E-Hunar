...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    image: '/src/assets/megha_convenor.JPG',
    color: 'from-[#FFD166] to-[#FF8A00]',
    accent: 'gold'
  },
  {
  ...
  // ── ⚙️ Management Team (Royal Blue) ──
  {
    ...
    image: '/src/assets/nitin_vbh.JPG',
  ...
  },
  {
    ...
    image: '/src/assets/suyash_ds.JPG',
    color: 'from-[#3B82F6] to-[#1D4ED8]',
    accent: 'blue'
  },
  {
    ...
    image: '/src/assets/gurudev_cus.JPG',
    color: 'from-[#3B82F6] to-[#1D4ED8]',
    accent: 'blue'
  },
  ...
  // ── 🎨 Creative & Design (Purple) ──
  {
    ...
    image: '/src/assets/rajlaxmi_vhg.JPG',
